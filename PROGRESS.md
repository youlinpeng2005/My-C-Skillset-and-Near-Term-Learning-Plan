...
next_task: "Day1 — SQL 复习 + chat_db schema 设计"
...
| 当前 day | **Day1**（2026/05/25 周一） |
| 上次完成的 day | — （month2 刚开工，month1 已收官） |
| 下一个待办 | Day1 — SQL 复习 + chat_db schema 设计 |
...
| 周 | 时间 | 主题 | 完成 day | 状态 |
|---|---|---|---|---|
| Week1 | 5/25 ~ 5/31 | MySQL 工程化 + 连接池 | 0 / 7 | 🔥 进行中 |
