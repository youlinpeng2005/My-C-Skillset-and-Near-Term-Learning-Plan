...
| 第3周 | 5/3~5/9    | 5/11~5/16    | 并发编程+手写线程池  | 🔥 进行中（今日开始，顺延一周）  |
| 第4周 | 5/10~5/18  | 5/17~5/18    | 工程级项目整合      | ⏳ 待开始（压缩至2天冲刺）  |

> ⚠️ **进度说明（2026/05/11 更新）**：第2周内容延期至 5/10 完成，整体落后约一周。
> 第3周（并发编程）从 5/11 起压缩执行，重点保证 day15/17/19/20 四个核心文件质量。
> 第4周工程项目（week4_project 框架已建好）利用周末 5/17~5/18 冲刺整合。
...
- [ ] Week3 结束：手写线程池，理解所有同步原语（目标 2026/05/16）
- [ ] Week4 结束：完成可写进简历的工程级聊天服务器（目标 2026/05/18）
